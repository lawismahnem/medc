	...
	<div class="body-cont">
	   ...
	   <div style="margin-top:6px;" id="content-holder">
		<?php 
			...
			<div style="background:url('<?php echo $datag['pb_imgurl']?>');  
			background-size: 100%;
			height:300px;" class="team-background-holder">
		
			<div class="team-header-holder">
					<div id="team-logo">
					<img  style="background:url('img/pplogo.jpg');background-size:100%;" src="<?php echo $datag['t_img'];?>"></img>
					</div>
					<div id="team-info">
					<h1><?php echo $datag['name']; $myteam=$datag['name'];?> </h1><h3>Rank: #9</h3>
						<div id="team-record">
						Winrate<p>0%</p>
						</div>
						<div id="team-record">
						Matches played <br><span style="color:#02f91f;">0</span> / <span style="color:#ff0000;">300</span> / <span>300</span>
						</div>
						<div id="team-record">
						Location<p><?php echo $datag['location'];?></p>
						</div>
						<div id="team-record">
						Reputation<p>1</p>
						</div>
			...
			<div id="myprofile-details">
				<h1>Roster</h1>
				<?php 
					$d=mysql_query("SELECT * FROM user_info where u_team='$myteam'");
				while ( $di=mysql_fetch_array($d))
					{
				?>
				<div id="t-roster"><a href="<?php echo $di['u_username'];?>">
				<img src="<?php echo $di['u_imgurl']?>"></img>
				<p style="color:white;"><?php echo $di['u_ign']?></p>
				<p><?php echo $di['u_fname']?> <?php echo $di['u_lname']?></p>
				</a></div>
				<?php
					}
				?>
