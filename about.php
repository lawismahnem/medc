...
?>
	...
	<div class="body-cont">
	   ...
	   <div style="margin-top:6px;" id="content-holder">
		...
		<h3>Middle East Dota 2 Community</h3>
		<p style="text-align:justify;width:90%;">
		A group for gamers by gamers. We are hoping to create a community of gamers of Dota in the middle east which will promote the love for the game. Hopefully we can do meet-ups and actual matches of the game and just have fun.
		</p>
		</center>
		</div>
		</div>
